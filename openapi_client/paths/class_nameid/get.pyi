...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'scope': typing.Union[ScopeSchema, ],
...
SchemaFor200ResponseBodyApplicationVnd3gppObjectTreeHierarchicaljson = Resource


class SchemaFor200ResponseBodyApplicationVnd3gppObjectTreeFlatjson(
    schemas.ListSchema
):
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['Resource'], typing.List['Resource']],
        _configuration: typing.Optional[schemas.Configuration] = None,
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.3gpp.object-tree-hierarchical+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVnd3gppObjectTreeHierarchicaljson),
        'application/vnd.3gpp.object-tree-flat+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVnd3gppObjectTreeFlatjson),
    },
)
...
class ClassNameidGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def class_nameid_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def class_nameid_get(
        ...
        return self._class_nameid_get_oapg(
