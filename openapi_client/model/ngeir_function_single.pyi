...
class NgeirFunctionSingle(
    ...
    class MetaOapg:
        ...
        class all_of_3(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["EP_N17", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EP_N17", ], str]):
                return super().get_item_oapg(name)
