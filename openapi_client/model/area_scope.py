    ...
    class MetaOapg:
        ...
        class one_of_2(
            ...
            class MetaOapg:
                ...
                @staticmethod
                def items() -> typing.Type['Tac']:
                    return Tac
        
            def __new__(
                cls,
                _arg: typing.Union[typing.Tuple['Tac'], typing.List['Tac']],
                _configuration: typing.Optional[schemas.Configuration] = None,
            ) -> 'one_of_2':
                return super().__new__(
                    cls,
            ...
            def __getitem__(self, i: int) -> 'Tac':
                return super().__getitem__(i)
        ...
        class one_of_3(
            ...
            class MetaOapg:
                ...
                @staticmethod
                def items() -> typing.Type['Tai']:
                    return Tai
        
            def __new__(
                cls,
                _arg: typing.Union[typing.Tuple['Tai'], typing.List['Tai']],
                _configuration: typing.Optional[schemas.Configuration] = None,
            ) -> 'one_of_3':
                return super().__new__(
                    cls,
            ...
            def __getitem__(self, i: int) -> 'Tai':
                return super().__getitem__(i)
