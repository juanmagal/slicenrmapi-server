...
class IpEndPoint(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ipv6Prefix() -> typing.Type['Ipv6Prefix']:
                return Ipv6Prefix
        
            @staticmethod
            def transport() -> typing.Type['TransportProtocol']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6Prefix"]) -> 'Ipv6Prefix': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["transport"]) -> 'TransportProtocol': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ipv4Address", "ipv6Address", "ipv6Prefix", "transport", "port", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6Prefix"]) -> typing.Union['Ipv6Prefix', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["transport"]) -> typing.Union['TransportProtocol', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ipv4Address", "ipv6Address", "ipv6Prefix", "transport", "port", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ipv6Prefix: typing.Union['Ipv6Prefix', schemas.Unset] = schemas.unset,
        transport: typing.Union['TransportProtocol', schemas.Unset] = schemas.unset,
