...
class AssuranceScope(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["taiList", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["taiList", ], str]):
