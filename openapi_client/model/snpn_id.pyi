...
class SnpnId(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mcc", "mnc", "nid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mcc", "mnc", "nid", ], str]):
