...
class GeographicalCoordinates(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lattitude", "longitude", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lattitude", "longitude", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        lattitude: typing.Union[MetaOapg.properties.lattitude, decimal.Decimal, int, schemas.Unset] = schemas.unset,
