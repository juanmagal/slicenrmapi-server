...
class ResourceSharingLevelContext(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class contextAttribute(
                ...
                def RESOURCE_SHARING_LEVEL(cls):
                    return cls("ResourceSharingLevel")
            ...
            class contextValueRange(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SharingLevel']:
                        return SharingLevel
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SharingLevel'], typing.List['SharingLevel']],
                ...
                def __getitem__(self, i: int) -> 'SharingLevel':
