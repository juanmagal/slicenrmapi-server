...
class AusfFunctionSingle(
    ...
    class MetaOapg:
                    ...
                    class attributes(
                        ...
                        class MetaOapg:
                            ...
                            class all_of_1(
                                ...
                                def __getitem__(self, name: typing.Union[typing_extensions.Literal["plmnIdList", "sBIFqdn", "snssaiList", "managedNFProfile", "commModelList", ], str]):
                                ...
                                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plmnIdList", "sBIFqdn", "snssaiList", "managedNFProfile", "commModelList", ], str]):
        ...
        class all_of_3(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["EP_N12", "EP_N13", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EP_N12", "EP_N13", ], str]):
                return super().get_item_oapg(name)
