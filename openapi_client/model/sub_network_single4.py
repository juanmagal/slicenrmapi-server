        ...
        class all_of_3(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def Intent() -> typing.Type['IntentMultiple']:
                        return IntentMultiple
                    __annotations__ = {
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["Intent"]) -> 'IntentMultiple': ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["SubNetwork", "Intent", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["Intent"]) -> typing.Union['IntentMultiple', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["SubNetwork", "Intent", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                ...
                *_args: typing.Union[dict, frozendict.frozendict, ],
                ...
                Intent: typing.Union['IntentMultiple', schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'all_of_3':
                return super().__new__(
