...
class TimeWindow(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["startTime", "endTime", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startTime", "endTime", ], str]):
