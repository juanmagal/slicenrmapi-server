...
class SubNetworkAttr(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            userDefinedNetworkType = schemas.StrSchema
            ...
            class setOfMcc(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Mcc']:
                        return Mcc
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Mcc'], typing.List['Mcc']],
                ...
                def __getitem__(self, i: int) -> 'Mcc':
            ...
            __annotations__ = {
                "dnPrefix": dnPrefix,
                "userLabel": userLabel,
                "userDefinedNetworkType": userDefinedNetworkType,
                "setOfMcc": setOfMcc,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["userDefinedNetworkType"]) -> MetaOapg.properties.userDefinedNetworkType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["setOfMcc"]) -> MetaOapg.properties.setOfMcc: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dnPrefix", "userLabel", "userDefinedNetworkType", "setOfMcc", "priorityLabel", "supportedPerfMetricGroups", "supportedTraceMetrics", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["userDefinedNetworkType"]) -> typing.Union[MetaOapg.properties.userDefinedNetworkType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["setOfMcc"]) -> typing.Union[MetaOapg.properties.setOfMcc, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dnPrefix", "userLabel", "userDefinedNetworkType", "setOfMcc", "priorityLabel", "supportedPerfMetricGroups", "supportedTraceMetrics", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        userDefinedNetworkType: typing.Union[MetaOapg.properties.userDefinedNetworkType, str, schemas.Unset] = schemas.unset,
        setOfMcc: typing.Union[MetaOapg.properties.setOfMcc, list, tuple, schemas.Unset] = schemas.unset,
