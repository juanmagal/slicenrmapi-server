    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class contextAttribute(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "CoverageAreaTac": "COVERAGE_AREA_TAC",
                    }
                
                @schemas.classproperty
                def COVERAGE_AREA_TAC(cls):
                    return cls("CoverageAreaTac")
            ...
            class contextValueRange(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NrTac']:
                        return NrTac
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['NrTac'], typing.List['NrTac']],
                ...
                def __getitem__(self, i: int) -> 'NrTac':
