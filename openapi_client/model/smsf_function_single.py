                    ...
                    class attributes(
                        ...
                        class MetaOapg:
                            ...
                            class all_of_1(
                                ...
                                def __getitem__(self, name: typing.Union[typing_extensions.Literal["plmnIdList", "sBIFqdn", "managedNFProfile", "commModelList", ], str]):
                                ...
                                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plmnIdList", "sBIFqdn", "managedNFProfile", "commModelList", ], str]):
        ...
        class all_of_3(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def EP_N21() -> typing.Type['EPN21Multiple']:
                        return EPN21Multiple
                
                    @staticmethod
                    def EP_MAP_SMSC() -> typing.Type['EPMAPSMSCMultiple']:
                        return EPMAPSMSCMultiple
                    __annotations__ = {
                        "EP_N20": EP_N20,
                        "EP_N21": EP_N21,
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["EP_N21"]) -> 'EPN21Multiple': ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["EP_MAP_SMSC"]) -> 'EPMAPSMSCMultiple': ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["EP_N20", "EP_N21", "EP_MAP_SMSC", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["EP_N21"]) -> typing.Union['EPN21Multiple', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["EP_MAP_SMSC"]) -> typing.Union['EPMAPSMSCMultiple', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EP_N20", "EP_N21", "EP_MAP_SMSC", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                ...
                *_args: typing.Union[dict, frozendict.frozendict, ],
                ...
                EP_N21: typing.Union['EPN21Multiple', schemas.Unset] = schemas.unset,
                EP_MAP_SMSC: typing.Union['EPMAPSMSCMultiple', schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'all_of_3':
                return super().__new__(
