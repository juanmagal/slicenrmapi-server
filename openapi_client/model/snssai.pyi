...
class Snssai(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sst", "sd", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sst", "sd", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        sd: typing.Union[MetaOapg.properties.sd, str, schemas.Unset] = schemas.unset,
