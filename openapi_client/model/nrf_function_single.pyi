                    ...
                    class attributes(
                        ...
                        class MetaOapg:
                            ...
                            class all_of_1(
                                ...
                                def __getitem__(self, name: typing.Union[typing_extensions.Literal["plmnIdList", "sBIFqdn", "cNSIIdList", "nFProfileList", "snssaiList", ], str]):
                                ...
                                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plmnIdList", "sBIFqdn", "cNSIIdList", "nFProfileList", "snssaiList", ], str]):
        ...
        class all_of_3(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def EP_N27() -> typing.Type['EPN27Multiple']:
                        return EPN27Multiple
                    __annotations__ = {
                        "EP_N27": EP_N27,
                    }
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["EP_N27"]) -> 'EPN27Multiple': ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["EP_N27", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["EP_N27"]) -> typing.Union['EPN27Multiple', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EP_N27", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                cls,
                *_args: typing.Union[dict, frozendict.frozendict, ],
                EP_N27: typing.Union['EPN27Multiple', schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'all_of_3':
                return super().__new__(
