...
class Synchronicity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["servAttrCom", "availability", "accuracy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["servAttrCom", "availability", "accuracy", ], str]):
