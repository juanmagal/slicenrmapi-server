...
class SupportedFunc(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["function", "policy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["function", "policy", ], str]):
