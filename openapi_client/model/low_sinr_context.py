...
class LowSINRContext(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class contextAttribute(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "LowSINRThreshold": "LOW_SINRTHRESHOLD",
                    }
                
                @schemas.classproperty
                def LOW_SINRTHRESHOLD(cls):
                    return cls("LowSINRThreshold")
            ...
            contextValueRange = schemas.IntSchema
            __annotations__ = {
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        contextValueRange: typing.Union[MetaOapg.properties.contextValueRange, decimal.Decimal, int, schemas.Unset] = schemas.unset,
