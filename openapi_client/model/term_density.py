...
class TermDensity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["servAttrCom", "density", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["servAttrCom", "density", ], str]):
