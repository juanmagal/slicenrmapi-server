# openapi_client.model.route_to_location.RouteToLocation
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict, None,  | frozendict.frozendict, NoneClass,  | At least one of the \&quot;routeInfo\&quot; attribute and the \&quot;routeProfId\&quot; attribute shall be included in the \&quot;RouteToLocation\&quot; data type.  | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**dnai** | str,  | str,  | DNAI (Data network access identifier), see clause 5.6.7 of 3GPP TS 23.501. | 
**routeInfo** | [**RouteInformation**](RouteInformation.md) | [**RouteInformation**](RouteInformation.md) |  | [optional] 
**routeProfId** | None, str,  | NoneClass, str,  | Identifies the routing profile Id. | [optional] 
