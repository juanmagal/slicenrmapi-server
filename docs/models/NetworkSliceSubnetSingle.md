# openapi_client.model.network_slice_subnet_single.NetworkSliceSubnetSingle
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**managedFunctionRefList** | [**DnList**](DnList.md) | [**DnList**](DnList.md) |  | [optional] 
**networkSliceSubnetRefList** | [**DnList**](DnList.md) | [**DnList**](DnList.md) |  | [optional] 
...
**nsInfo** | [**NsInfo**](NsInfo.md) | [**NsInfo**](NsInfo.md) |  | [optional] 
**sliceProfileList** | [**SliceProfileList**](SliceProfileList.md) | [**SliceProfileList**](SliceProfileList.md) |  | [optional] 
**epTransportRefList** | [**DnList**](DnList.md) | [**DnList**](DnList.md) |  | [optional] 
**priorityLabel** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] 
**networkSliceSubnetType** | str,  | str,  |  | [optional] must be one of ["TOP_SLICESUBNET", "RAN_SLICESUBNET", "CN_SLICESUBNET", ] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
