# openapi_client.model.nef_function_single.NefFunctionSingle
...
**capabilityList** | [**CapabilityList**](CapabilityList.md) | [**CapabilityList**](CapabilityList.md) |  | [optional] 
**isCAPIFSup** | bool,  | BoolClass,  |  | [optional] 
**taiList** | [**TaiList**](TaiList.md) | [**TaiList**](TaiList.md) |  | [optional] 
**[taiRangeList](#taiRangeList)** | list, tuple,  | tuple,  |  | [optional] 
**dnai** | str,  | str,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**EP_N33** | [**EPN33Multiple**](EPN33Multiple.md) | [**EPN33Multiple**](EPN33Multiple.md) |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
