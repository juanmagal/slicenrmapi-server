# openapi_client.model.threshold_monitor_single.ThresholdMonitorSingle
...
**[thresholdInfoList](#thresholdInfoList)** | list, tuple,  | tuple,  |  | [optional] 
**monitorGranularityPeriod** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**ThresholdInfo**](ThresholdInfo.md) | [**ThresholdInfo**](ThresholdInfo.md) | [**ThresholdInfo**](ThresholdInfo.md) |  | 
