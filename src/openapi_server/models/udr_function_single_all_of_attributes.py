...
class UdrFunctionSingleAllOfAttributes(BaseModel):
    ...
    UdrFunctionSingleAllOfAttributes - a model defined in OpenAPI
        ...
        user_label: The user_label of this UdrFunctionSingleAllOfAttributes [Optional].
        vnf_parameters_list: The vnf_parameters_list of this UdrFunctionSingleAllOfAttributes [Optional].
        pee_parameters_list: The pee_parameters_list of this UdrFunctionSingleAllOfAttributes [Optional].
        priority_label: The priority_label of this UdrFunctionSingleAllOfAttributes [Optional].
        supported_perf_metric_groups: The supported_perf_metric_groups of this UdrFunctionSingleAllOfAttributes [Optional].
        supported_trace_metrics: The supported_trace_metrics of this UdrFunctionSingleAllOfAttributes [Optional].
        plmn_id_list: The plmn_id_list of this UdrFunctionSingleAllOfAttributes [Optional].
        s_bi_fqdn: The s_bi_fqdn of this UdrFunctionSingleAllOfAttributes [Optional].
        snssai_list: The snssai_list of this UdrFunctionSingleAllOfAttributes [Optional].
        managed_nf_profile: The managed_nf_profile of this UdrFunctionSingleAllOfAttributes [Optional].
    """
...
UdrFunctionSingleAllOfAttributes.update_forward_refs()
