...
class EPNpc7Single(BaseModel):
    ...
    EPNpc7Single - a model defined in OpenAPI
        ...
        id: The id of this EPNpc7Single.
        object_class: The object_class of this EPNpc7Single [Optional].
        object_instance: The object_instance of this EPNpc7Single [Optional].
        vs_data_container: The vs_data_container of this EPNpc7Single [Optional].
        attributes: The attributes of this EPNpc7Single [Optional].
    """
