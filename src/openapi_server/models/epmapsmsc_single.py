...
class EPMAPSMSCSingle(BaseModel):
    ...
    EPMAPSMSCSingle - a model defined in OpenAPI
        ...
        id: The id of this EPMAPSMSCSingle.
        object_class: The object_class of this EPMAPSMSCSingle [Optional].
        object_instance: The object_instance of this EPMAPSMSCSingle [Optional].
        vs_data_container: The vs_data_container of this EPMAPSMSCSingle [Optional].
        attributes: The attributes of this EPMAPSMSCSingle [Optional].
    """
