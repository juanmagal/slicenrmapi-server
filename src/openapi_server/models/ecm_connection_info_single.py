...
class EcmConnectionInfoSingle(BaseModel):
    ...
    EcmConnectionInfoSingle - a model defined in OpenAPI
        ...
        id: The id of this EcmConnectionInfoSingle.
        object_class: The object_class of this EcmConnectionInfoSingle [Optional].
        object_instance: The object_instance of this EcmConnectionInfoSingle [Optional].
        vs_data_container: The vs_data_container of this EcmConnectionInfoSingle [Optional].
        attributes: The attributes of this EcmConnectionInfoSingle [Optional].
    """
