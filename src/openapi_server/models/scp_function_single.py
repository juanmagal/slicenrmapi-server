...
class ScpFunctionSingle(BaseModel):
    ...
    ScpFunctionSingle - a model defined in OpenAPI
        ...
        id: The id of this ScpFunctionSingle.
        object_class: The object_class of this ScpFunctionSingle [Optional].
        object_instance: The object_instance of this ScpFunctionSingle [Optional].
        vs_data_container: The vs_data_container of this ScpFunctionSingle [Optional].
        attributes: The attributes of this ScpFunctionSingle [Optional].
        perf_metric_job: The perf_metric_job of this ScpFunctionSingle [Optional].
        threshold_monitor: The threshold_monitor of this ScpFunctionSingle [Optional].
        managed_nf_service: The managed_nf_service of this ScpFunctionSingle [Optional].
        trace_job: The trace_job of this ScpFunctionSingle [Optional].
    """
    ...
    attributes: Optional[ScpFunctionSingleAllOfAttributes] = Field(alias="attributes", default=None)
