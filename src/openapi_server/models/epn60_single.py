...
class EPN60Single(BaseModel):
    ...
    EPN60Single - a model defined in OpenAPI
        ...
        id: The id of this EPN60Single.
        object_class: The object_class of this EPN60Single [Optional].
        object_instance: The object_instance of this EPN60Single [Optional].
        vs_data_container: The vs_data_container of this EPN60Single [Optional].
        attributes: The attributes of this EPN60Single [Optional].
    """
