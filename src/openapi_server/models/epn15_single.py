...
class EPN15Single(BaseModel):
    ...
    EPN15Single - a model defined in OpenAPI
        ...
        id: The id of this EPN15Single.
        object_class: The object_class of this EPN15Single [Optional].
        object_instance: The object_instance of this EPN15Single [Optional].
        vs_data_container: The vs_data_container of this EPN15Single [Optional].
        attributes: The attributes of this EPN15Single [Optional].
    """
