...
class EPNgCSingle(BaseModel):
    ...
    EPNgCSingle - a model defined in OpenAPI
        ...
        id: The id of this EPNgCSingle.
        object_class: The object_class of this EPNgCSingle [Optional].
        object_instance: The object_instance of this EPNgCSingle [Optional].
        vs_data_container: The vs_data_container of this EPNgCSingle [Optional].
        attributes: The attributes of this EPNgCSingle [Optional].
    """
