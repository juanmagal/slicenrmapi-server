...
class EPRxSingle(BaseModel):
    ...
    EPRxSingle - a model defined in OpenAPI
        ...
        id: The id of this EPRxSingle.
        object_class: The object_class of this EPRxSingle [Optional].
        object_instance: The object_instance of this EPRxSingle [Optional].
        vs_data_container: The vs_data_container of this EPRxSingle [Optional].
        attributes: The attributes of this EPRxSingle [Optional].
    """
