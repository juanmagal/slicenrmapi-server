...
class EPN7Single(BaseModel):
    ...
    EPN7Single - a model defined in OpenAPI
        ...
        id: The id of this EPN7Single.
        object_class: The object_class of this EPN7Single [Optional].
        object_instance: The object_instance of this EPN7Single [Optional].
        vs_data_container: The vs_data_container of this EPN7Single [Optional].
        attributes: The attributes of this EPN7Single [Optional].
    """
