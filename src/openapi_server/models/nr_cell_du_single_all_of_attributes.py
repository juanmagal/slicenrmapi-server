...
class NrCellDuSingleAllOfAttributes(BaseModel):
    ...
    NrCellDuSingleAllOfAttributes - a model defined in OpenAPI
        ...
        user_label: The user_label of this NrCellDuSingleAllOfAttributes [Optional].
        vnf_parameters_list: The vnf_parameters_list of this NrCellDuSingleAllOfAttributes [Optional].
        pee_parameters_list: The pee_parameters_list of this NrCellDuSingleAllOfAttributes [Optional].
        priority_label: The priority_label of this NrCellDuSingleAllOfAttributes [Optional].
        supported_perf_metric_groups: The supported_perf_metric_groups of this NrCellDuSingleAllOfAttributes [Optional].
        supported_trace_metrics: The supported_trace_metrics of this NrCellDuSingleAllOfAttributes [Optional].
        administrative_state: The administrative_state of this NrCellDuSingleAllOfAttributes [Optional].
        operational_state: The operational_state of this NrCellDuSingleAllOfAttributes [Optional].
        cell_local_id: The cell_local_id of this NrCellDuSingleAllOfAttributes [Optional].
        cell_state: The cell_state of this NrCellDuSingleAllOfAttributes [Optional].
        plmn_info_list: The plmn_info_list of this NrCellDuSingleAllOfAttributes [Optional].
        npn_identity_list: The npn_identity_list of this NrCellDuSingleAllOfAttributes [Optional].
        nr_pci: The nr_pci of this NrCellDuSingleAllOfAttributes [Optional].
        nr_tac: The nr_tac of this NrCellDuSingleAllOfAttributes [Optional].
        arfcn_dl: The arfcn_dl of this NrCellDuSingleAllOfAttributes [Optional].
        arfcn_ul: The arfcn_ul of this NrCellDuSingleAllOfAttributes [Optional].
        arfcn_sul: The arfcn_sul of this NrCellDuSingleAllOfAttributes [Optional].
        b_s_channel_bw_dl: The b_s_channel_bw_dl of this NrCellDuSingleAllOfAttributes [Optional].
        b_s_channel_bw_ul: The b_s_channel_bw_ul of this NrCellDuSingleAllOfAttributes [Optional].
        b_s_channel_bw_sul: The b_s_channel_bw_sul of this NrCellDuSingleAllOfAttributes [Optional].
        ssb_frequency: The ssb_frequency of this NrCellDuSingleAllOfAttributes [Optional].
        ssb_periodicity: The ssb_periodicity of this NrCellDuSingleAllOfAttributes [Optional].
        ssb_sub_carrier_spacing: The ssb_sub_carrier_spacing of this NrCellDuSingleAllOfAttributes [Optional].
        ssb_offset: The ssb_offset of this NrCellDuSingleAllOfAttributes [Optional].
        ssb_duration: The ssb_duration of this NrCellDuSingleAllOfAttributes [Optional].
        nr_sector_carrier_ref: The nr_sector_carrier_ref of this NrCellDuSingleAllOfAttributes [Optional].
        bwp_ref: The bwp_ref of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_start_time: The rim_rs_monitoring_start_time of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_stop_time: The rim_rs_monitoring_stop_time of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_window_duration: The rim_rs_monitoring_window_duration of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_window_starting_offset: The rim_rs_monitoring_window_starting_offset of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_window_periodicity: The rim_rs_monitoring_window_periodicity of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_occasion_interval: The rim_rs_monitoring_occasion_interval of this NrCellDuSingleAllOfAttributes [Optional].
        rim_rs_monitoring_occasion_starting_offset: The rim_rs_monitoring_occasion_starting_offset of this NrCellDuSingleAllOfAttributes [Optional].
        n_r_frequency_ref: The n_r_frequency_ref of this NrCellDuSingleAllOfAttributes [Optional].
        victim_set_ref: The victim_set_ref of this NrCellDuSingleAllOfAttributes [Optional].
        aggressor_set_ref: The aggressor_set_ref of this NrCellDuSingleAllOfAttributes [Optional].
    """
...
NrCellDuSingleAllOfAttributes.update_forward_refs()
