...
class EPN14Single(BaseModel):
    ...
    EPN14Single - a model defined in OpenAPI
        ...
        id: The id of this EPN14Single.
        object_class: The object_class of this EPN14Single [Optional].
        object_instance: The object_instance of this EPN14Single [Optional].
        vs_data_container: The vs_data_container of this EPN14Single [Optional].
        attributes: The attributes of this EPN14Single [Optional].
    """
