...
class EPNpc6Single(BaseModel):
    ...
    EPNpc6Single - a model defined in OpenAPI
        ...
        id: The id of this EPNpc6Single.
        object_class: The object_class of this EPNpc6Single [Optional].
        object_instance: The object_instance of this EPNpc6Single [Optional].
        vs_data_container: The vs_data_container of this EPNpc6Single [Optional].
        attributes: The attributes of this EPNpc6Single [Optional].
    """
