...
class ExternalEUTranCellSingle(BaseModel):
    ...
    ExternalEUTranCellSingle - a model defined in OpenAPI
        ...
        id: The id of this ExternalEUTranCellSingle.
        object_class: The object_class of this ExternalEUTranCellSingle [Optional].
        object_instance: The object_instance of this ExternalEUTranCellSingle [Optional].
        vs_data_container: The vs_data_container of this ExternalEUTranCellSingle [Optional].
        attributes: The attributes of this ExternalEUTranCellSingle [Optional].
        perf_metric_job: The perf_metric_job of this ExternalEUTranCellSingle [Optional].
        threshold_monitor: The threshold_monitor of this ExternalEUTranCellSingle [Optional].
        managed_nf_service: The managed_nf_service of this ExternalEUTranCellSingle [Optional].
        trace_job: The trace_job of this ExternalEUTranCellSingle [Optional].
    """
