...
class ExternalNrCellCuSingle(BaseModel):
    ...
    ExternalNrCellCuSingle - a model defined in OpenAPI
        ...
        id: The id of this ExternalNrCellCuSingle.
        object_class: The object_class of this ExternalNrCellCuSingle [Optional].
        object_instance: The object_instance of this ExternalNrCellCuSingle [Optional].
        vs_data_container: The vs_data_container of this ExternalNrCellCuSingle [Optional].
        attributes: The attributes of this ExternalNrCellCuSingle [Optional].
        perf_metric_job: The perf_metric_job of this ExternalNrCellCuSingle [Optional].
        threshold_monitor: The threshold_monitor of this ExternalNrCellCuSingle [Optional].
        managed_nf_service: The managed_nf_service of this ExternalNrCellCuSingle [Optional].
        trace_job: The trace_job of this ExternalNrCellCuSingle [Optional].
    """
