...
class ExpectationContext(BaseModel):
    ...
    ExpectationContext - a model defined in OpenAPI
        ...
        context_attribute: The context_attribute of this ExpectationContext [Optional].
        context_condition: The context_condition of this ExpectationContext [Optional].
        context_value_range: The context_value_range of this ExpectationContext [Optional].
    """
...
ExpectationContext.update_forward_refs()
