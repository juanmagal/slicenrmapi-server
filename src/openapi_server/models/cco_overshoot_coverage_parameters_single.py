...
class CCOOvershootCoverageParametersSingle(BaseModel):
    ...
    CCOOvershootCoverageParametersSingle - a model defined in OpenAPI
        ...
        id: The id of this CCOOvershootCoverageParametersSingle.
        object_class: The object_class of this CCOOvershootCoverageParametersSingle [Optional].
        object_instance: The object_instance of this CCOOvershootCoverageParametersSingle [Optional].
        vs_data_container: The vs_data_container of this CCOOvershootCoverageParametersSingle [Optional].
        attributes: The attributes of this CCOOvershootCoverageParametersSingle [Optional].
    """
