...
class Top(BaseModel):
    ...
    Top - a model defined in OpenAPI
        ...
        id: The id of this Top.
        object_class: The object_class of this Top [Optional].
        object_instance: The object_instance of this Top [Optional].
        vs_data_container: The vs_data_container of this Top [Optional].
    """
