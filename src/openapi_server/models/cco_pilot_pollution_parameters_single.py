...
class CCOPilotPollutionParametersSingle(BaseModel):
    ...
    CCOPilotPollutionParametersSingle - a model defined in OpenAPI
        ...
        id: The id of this CCOPilotPollutionParametersSingle.
        object_class: The object_class of this CCOPilotPollutionParametersSingle [Optional].
        object_instance: The object_instance of this CCOPilotPollutionParametersSingle [Optional].
        vs_data_container: The vs_data_container of this CCOPilotPollutionParametersSingle [Optional].
        attributes: The attributes of this CCOPilotPollutionParametersSingle [Optional].
    """
