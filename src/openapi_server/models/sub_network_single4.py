...
class SubNetworkSingle4(BaseModel):
    ...
    SubNetworkSingle4 - a model defined in OpenAPI
        ...
        id: The id of this SubNetworkSingle4.
        object_class: The object_class of this SubNetworkSingle4 [Optional].
        object_instance: The object_instance of this SubNetworkSingle4 [Optional].
        vs_data_container: The vs_data_container of this SubNetworkSingle4 [Optional].
        attributes: The attributes of this SubNetworkSingle4 [Optional].
        management_node: The management_node of this SubNetworkSingle4 [Optional].
        mns_agent: The mns_agent of this SubNetworkSingle4 [Optional].
        me_context: The me_context of this SubNetworkSingle4 [Optional].
        perf_metric_job: The perf_metric_job of this SubNetworkSingle4 [Optional].
        threshold_monitor: The threshold_monitor of this SubNetworkSingle4 [Optional].
        trace_job: The trace_job of this SubNetworkSingle4 [Optional].
        management_data_collection: The management_data_collection of this SubNetworkSingle4 [Optional].
        ntf_subscription_control: The ntf_subscription_control of this SubNetworkSingle4 [Optional].
        alarm_list: The alarm_list of this SubNetworkSingle4 [Optional].
        file_download_job: The file_download_job of this SubNetworkSingle4 [Optional].
        files: The files of this SubNetworkSingle4 [Optional].
        mns_registry: The mns_registry of this SubNetworkSingle4 [Optional].
        sub_network: The sub_network of this SubNetworkSingle4 [Optional].
        intent: The intent of this SubNetworkSingle4 [Optional].
    """
...
SubNetworkSingle4.update_forward_refs()
