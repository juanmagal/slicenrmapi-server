...
class EPNpc8Single(BaseModel):
    ...
    EPNpc8Single - a model defined in OpenAPI
        ...
        id: The id of this EPNpc8Single.
        object_class: The object_class of this EPNpc8Single [Optional].
        object_instance: The object_instance of this EPNpc8Single [Optional].
        vs_data_container: The vs_data_container of this EPNpc8Single [Optional].
        attributes: The attributes of this EPNpc8Single [Optional].
    """
