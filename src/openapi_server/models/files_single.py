...
class FilesSingle(BaseModel):
    ...
    FilesSingle - a model defined in OpenAPI
        ...
        id: The id of this FilesSingle.
        object_class: The object_class of this FilesSingle [Optional].
        object_instance: The object_instance of this FilesSingle [Optional].
        vs_data_container: The vs_data_container of this FilesSingle [Optional].
        attributes: The attributes of this FilesSingle [Optional].
    """
