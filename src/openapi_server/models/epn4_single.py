...
class EPN4Single(BaseModel):
    ...
    EPN4Single - a model defined in OpenAPI
        ...
        id: The id of this EPN4Single.
        object_class: The object_class of this EPN4Single [Optional].
        object_instance: The object_instance of this EPN4Single [Optional].
        vs_data_container: The vs_data_container of this EPN4Single [Optional].
        attributes: The attributes of this EPN4Single [Optional].
    """
