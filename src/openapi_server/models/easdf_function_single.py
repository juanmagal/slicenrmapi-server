...
class EASDFFunctionSingle(BaseModel):
    ...
    EASDFFunctionSingle - a model defined in OpenAPI
        ...
        id: The id of this EASDFFunctionSingle.
        object_class: The object_class of this EASDFFunctionSingle [Optional].
        object_instance: The object_instance of this EASDFFunctionSingle [Optional].
        vs_data_container: The vs_data_container of this EASDFFunctionSingle [Optional].
        attributes: The attributes of this EASDFFunctionSingle [Optional].
        perf_metric_job: The perf_metric_job of this EASDFFunctionSingle [Optional].
        threshold_monitor: The threshold_monitor of this EASDFFunctionSingle [Optional].
        managed_nf_service: The managed_nf_service of this EASDFFunctionSingle [Optional].
        trace_job: The trace_job of this EASDFFunctionSingle [Optional].
        ep_n88: The ep_n88 of this EASDFFunctionSingle [Optional].
    """
