...
class EPN9Single(BaseModel):
    ...
    EPN9Single - a model defined in OpenAPI
        ...
        id: The id of this EPN9Single.
        object_class: The object_class of this EPN9Single [Optional].
        object_instance: The object_instance of this EPN9Single [Optional].
        vs_data_container: The vs_data_container of this EPN9Single [Optional].
        attributes: The attributes of this EPN9Single [Optional].
    """
