...
class EPN17Single(BaseModel):
    ...
    EPN17Single - a model defined in OpenAPI
        ...
        id: The id of this EPN17Single.
        object_class: The object_class of this EPN17Single [Optional].
        object_instance: The object_instance of this EPN17Single [Optional].
        vs_data_container: The vs_data_container of this EPN17Single [Optional].
        attributes: The attributes of this EPN17Single [Optional].
    """
