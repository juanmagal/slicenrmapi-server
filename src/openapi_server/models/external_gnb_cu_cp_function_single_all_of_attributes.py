...
class ExternalGnbCuCpFunctionSingleAllOfAttributes(BaseModel):
    ...
    ExternalGnbCuCpFunctionSingleAllOfAttributes - a model defined in OpenAPI
        ...
        user_label: The user_label of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        vnf_parameters_list: The vnf_parameters_list of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        pee_parameters_list: The pee_parameters_list of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        priority_label: The priority_label of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        supported_perf_metric_groups: The supported_perf_metric_groups of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        supported_trace_metrics: The supported_trace_metrics of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        gnb_id: The gnb_id of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        gnb_id_length: The gnb_id_length of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
        plmn_id: The plmn_id of this ExternalGnbCuCpFunctionSingleAllOfAttributes [Optional].
    """
...
ExternalGnbCuCpFunctionSingleAllOfAttributes.update_forward_refs()
