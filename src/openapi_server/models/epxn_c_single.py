...
class EPXnCSingle(BaseModel):
    ...
    EPXnCSingle - a model defined in OpenAPI
        ...
        id: The id of this EPXnCSingle.
        object_class: The object_class of this EPXnCSingle [Optional].
        object_instance: The object_instance of this EPXnCSingle [Optional].
        vs_data_container: The vs_data_container of this EPXnCSingle [Optional].
        attributes: The attributes of this EPXnCSingle [Optional].
    """
