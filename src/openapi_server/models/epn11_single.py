...
class EPN11Single(BaseModel):
    ...
    EPN11Single - a model defined in OpenAPI
        ...
        id: The id of this EPN11Single.
        object_class: The object_class of this EPN11Single [Optional].
        object_instance: The object_instance of this EPN11Single [Optional].
        vs_data_container: The vs_data_container of this EPN11Single [Optional].
        attributes: The attributes of this EPN11Single [Optional].
    """
