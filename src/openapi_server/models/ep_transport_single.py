...
class EPTransportSingle(BaseModel):
    ...
    EPTransportSingle - a model defined in OpenAPI
        ...
        id: The id of this EPTransportSingle.
        object_class: The object_class of this EPTransportSingle [Optional].
        object_instance: The object_instance of this EPTransportSingle [Optional].
        vs_data_container: The vs_data_container of this EPTransportSingle [Optional].
        attributes: The attributes of this EPTransportSingle [Optional].
    """
