...
class EPNpc4Single(BaseModel):
    ...
    EPNpc4Single - a model defined in OpenAPI
        ...
        id: The id of this EPNpc4Single.
        object_class: The object_class of this EPNpc4Single [Optional].
        object_instance: The object_instance of this EPNpc4Single [Optional].
        vs_data_container: The vs_data_container of this EPNpc4Single [Optional].
        attributes: The attributes of this EPNpc4Single [Optional].
    """
