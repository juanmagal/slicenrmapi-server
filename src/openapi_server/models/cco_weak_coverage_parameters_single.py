...
class CCOWeakCoverageParametersSingle(BaseModel):
    ...
    CCOWeakCoverageParametersSingle - a model defined in OpenAPI
        ...
        id: The id of this CCOWeakCoverageParametersSingle.
        object_class: The object_class of this CCOWeakCoverageParametersSingle [Optional].
        object_instance: The object_instance of this CCOWeakCoverageParametersSingle [Optional].
        vs_data_container: The vs_data_container of this CCOWeakCoverageParametersSingle [Optional].
        attributes: The attributes of this CCOWeakCoverageParametersSingle [Optional].
    """
