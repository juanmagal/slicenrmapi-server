...
class EPN16Single(BaseModel):
    ...
    EPN16Single - a model defined in OpenAPI
        ...
        id: The id of this EPN16Single.
        object_class: The object_class of this EPN16Single [Optional].
        object_instance: The object_instance of this EPN16Single [Optional].
        vs_data_container: The vs_data_container of this EPN16Single [Optional].
        attributes: The attributes of this EPN16Single [Optional].
    """
