...
class EPNLSSingle(BaseModel):
    ...
    EPNLSSingle - a model defined in OpenAPI
        ...
        id: The id of this EPNLSSingle.
        object_class: The object_class of this EPNLSSingle [Optional].
        object_instance: The object_instance of this EPNLSSingle [Optional].
        vs_data_container: The vs_data_container of this EPNLSSingle [Optional].
        attributes: The attributes of this EPNLSSingle [Optional].
    """
