...
class AveDLRANUEThptTarget(BaseModel):
    ...
    AveDLRANUEThptTarget - a model defined in OpenAPI
        ...
        target_name: The target_name of this AveDLRANUEThptTarget [Optional].
        target_condition: The target_condition of this AveDLRANUEThptTarget [Optional].
        target_value_range: The target_value_range of this AveDLRANUEThptTarget [Optional].
        target_fulfilment_info: The target_fulfilment_info of this AveDLRANUEThptTarget [Optional].
    """
...
AveDLRANUEThptTarget.update_forward_refs()
