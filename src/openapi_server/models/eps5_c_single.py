...
class EPS5CSingle(BaseModel):
    ...
    EPS5CSingle - a model defined in OpenAPI
        ...
        id: The id of this EPS5CSingle.
        object_class: The object_class of this EPS5CSingle [Optional].
        object_instance: The object_instance of this EPS5CSingle [Optional].
        vs_data_container: The vs_data_container of this EPS5CSingle [Optional].
        attributes: The attributes of this EPS5CSingle [Optional].
    """
