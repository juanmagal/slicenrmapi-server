...
class ObjectContext(BaseModel):
    ...
    ObjectContext - a model defined in OpenAPI
        ...
        context_attribute: The context_attribute of this ObjectContext [Optional].
        context_condition: The context_condition of this ObjectContext [Optional].
        context_value_range: The context_value_range of this ObjectContext [Optional].
    """
...
ObjectContext.update_forward_refs()
