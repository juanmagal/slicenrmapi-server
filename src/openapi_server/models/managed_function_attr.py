...
class ManagedFunctionAttr(BaseModel):
    ...
    ManagedFunctionAttr - a model defined in OpenAPI
        ...
        user_label: The user_label of this ManagedFunctionAttr [Optional].
        vnf_parameters_list: The vnf_parameters_list of this ManagedFunctionAttr [Optional].
        pee_parameters_list: The pee_parameters_list of this ManagedFunctionAttr [Optional].
        priority_label: The priority_label of this ManagedFunctionAttr [Optional].
        supported_perf_metric_groups: The supported_perf_metric_groups of this ManagedFunctionAttr [Optional].
        supported_trace_metrics: The supported_trace_metrics of this ManagedFunctionAttr [Optional].
    """
...
ManagedFunctionAttr.update_forward_refs()
