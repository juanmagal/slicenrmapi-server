...
class EUtranCellRelationSingleAllOf(BaseModel):
    ...
    EUtranCellRelationSingleAllOf - a model defined in OpenAPI
        ...
        attributes: The attributes of this EUtranCellRelationSingleAllOf [Optional].
    """

    attributes: Optional[EUtranCellRelationSingleAllOfAttributes] = Field(alias="attributes", default=None)

EUtranCellRelationSingleAllOf.update_forward_refs()
