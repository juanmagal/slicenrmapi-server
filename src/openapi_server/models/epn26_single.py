...
class EPN26Single(BaseModel):
    ...
    EPN26Single - a model defined in OpenAPI
        ...
        id: The id of this EPN26Single.
        object_class: The object_class of this EPN26Single [Optional].
        object_instance: The object_instance of this EPN26Single [Optional].
        vs_data_container: The vs_data_container of this EPN26Single [Optional].
        attributes: The attributes of this EPN26Single [Optional].
    """
