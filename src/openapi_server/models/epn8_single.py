...
class EPN8Single(BaseModel):
    ...
    EPN8Single - a model defined in OpenAPI
        ...
        id: The id of this EPN8Single.
        object_class: The object_class of this EPN8Single [Optional].
        object_instance: The object_instance of this EPN8Single [Optional].
        vs_data_container: The vs_data_container of this EPN8Single [Optional].
        attributes: The attributes of this EPN8Single [Optional].
    """
