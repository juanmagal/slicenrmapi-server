...
class CCOParametersAttr(BaseModel):
    ...
    CCOParametersAttr - a model defined in OpenAPI
        ...
        id: The id of this CCOParametersAttr.
        object_class: The object_class of this CCOParametersAttr [Optional].
        object_instance: The object_instance of this CCOParametersAttr [Optional].
        vs_data_container: The vs_data_container of this CCOParametersAttr [Optional].
        attributes: The attributes of this CCOParametersAttr [Optional].
    """
