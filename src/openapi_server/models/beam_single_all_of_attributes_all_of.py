...
class BeamSingleAllOfAttributesAllOf(BaseModel):
    ...
    BeamSingleAllOfAttributesAllOf - a model defined in OpenAPI
        ...
        beam_index: The beam_index of this BeamSingleAllOfAttributesAllOf [Optional].
        beam_type: The beam_type of this BeamSingleAllOfAttributesAllOf [Optional].
        beam_azimuth: The beam_azimuth of this BeamSingleAllOfAttributesAllOf [Optional].
        beam_tilt: The beam_tilt of this BeamSingleAllOfAttributesAllOf [Optional].
        beam_horiz_width: The beam_horiz_width of this BeamSingleAllOfAttributesAllOf [Optional].
        beam_vert_width: The beam_vert_width of this BeamSingleAllOfAttributesAllOf [Optional].
    """
...
BeamSingleAllOfAttributesAllOf.update_forward_refs()
