...
class EPN13Single(BaseModel):
    ...
    EPN13Single - a model defined in OpenAPI
        ...
        id: The id of this EPN13Single.
        object_class: The object_class of this EPN13Single [Optional].
        object_instance: The object_instance of this EPN13Single [Optional].
        vs_data_container: The vs_data_container of this EPN13Single [Optional].
        attributes: The attributes of this EPN13Single [Optional].
    """
