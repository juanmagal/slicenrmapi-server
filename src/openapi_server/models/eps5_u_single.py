...
class EPS5USingle(BaseModel):
    ...
    EPS5USingle - a model defined in OpenAPI
        ...
        id: The id of this EPS5USingle.
        object_class: The object_class of this EPS5USingle [Optional].
        object_instance: The object_instance of this EPS5USingle [Optional].
        vs_data_container: The vs_data_container of this EPS5USingle [Optional].
        attributes: The attributes of this EPS5USingle [Optional].
    """
