...
class AusfFunctionSingleAllOfAttributes(BaseModel):
    ...
    AusfFunctionSingleAllOfAttributes - a model defined in OpenAPI
        ...
        user_label: The user_label of this AusfFunctionSingleAllOfAttributes [Optional].
        vnf_parameters_list: The vnf_parameters_list of this AusfFunctionSingleAllOfAttributes [Optional].
        pee_parameters_list: The pee_parameters_list of this AusfFunctionSingleAllOfAttributes [Optional].
        priority_label: The priority_label of this AusfFunctionSingleAllOfAttributes [Optional].
        supported_perf_metric_groups: The supported_perf_metric_groups of this AusfFunctionSingleAllOfAttributes [Optional].
        supported_trace_metrics: The supported_trace_metrics of this AusfFunctionSingleAllOfAttributes [Optional].
        plmn_id_list: The plmn_id_list of this AusfFunctionSingleAllOfAttributes [Optional].
        s_bi_fqdn: The s_bi_fqdn of this AusfFunctionSingleAllOfAttributes [Optional].
        snssai_list: The snssai_list of this AusfFunctionSingleAllOfAttributes [Optional].
        managed_nf_profile: The managed_nf_profile of this AusfFunctionSingleAllOfAttributes [Optional].
        comm_model_list: The comm_model_list of this AusfFunctionSingleAllOfAttributes [Optional].
    """
...
AusfFunctionSingleAllOfAttributes.update_forward_refs()
