...
class RRMPolicyRatioSingle(BaseModel):
    ...
    RRMPolicyRatioSingle - a model defined in OpenAPI
        ...
        id: The id of this RRMPolicyRatioSingle.
        object_class: The object_class of this RRMPolicyRatioSingle [Optional].
        object_instance: The object_instance of this RRMPolicyRatioSingle [Optional].
        vs_data_container: The vs_data_container of this RRMPolicyRatioSingle [Optional].
        attributes: The attributes of this RRMPolicyRatioSingle [Optional].
    """
