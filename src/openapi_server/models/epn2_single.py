...
class EPN2Single(BaseModel):
    ...
    EPN2Single - a model defined in OpenAPI
        ...
        id: The id of this EPN2Single.
        object_class: The object_class of this EPN2Single [Optional].
        object_instance: The object_instance of this EPN2Single [Optional].
        vs_data_container: The vs_data_container of this EPN2Single [Optional].
        attributes: The attributes of this EPN2Single [Optional].
    """
