...
class DLBOFunctionSingle(BaseModel):
    ...
    DLBOFunctionSingle - a model defined in OpenAPI
        ...
        id: The id of this DLBOFunctionSingle.
        object_class: The object_class of this DLBOFunctionSingle [Optional].
        object_instance: The object_instance of this DLBOFunctionSingle [Optional].
        vs_data_container: The vs_data_container of this DLBOFunctionSingle [Optional].
        attributes: The attributes of this DLBOFunctionSingle [Optional].
    """
    ...
    attributes: Optional[DLBOFunctionSingleAllOfAttributes] = Field(alias="attributes", default=None)
