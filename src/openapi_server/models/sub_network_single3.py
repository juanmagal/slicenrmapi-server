...
class SubNetworkSingle3(BaseModel):
    ...
    SubNetworkSingle3 - a model defined in OpenAPI
        ...
        id: The id of this SubNetworkSingle3.
        object_class: The object_class of this SubNetworkSingle3 [Optional].
        object_instance: The object_instance of this SubNetworkSingle3 [Optional].
        vs_data_container: The vs_data_container of this SubNetworkSingle3 [Optional].
        attributes: The attributes of this SubNetworkSingle3 [Optional].
        management_node: The management_node of this SubNetworkSingle3 [Optional].
        mns_agent: The mns_agent of this SubNetworkSingle3 [Optional].
        me_context: The me_context of this SubNetworkSingle3 [Optional].
        perf_metric_job: The perf_metric_job of this SubNetworkSingle3 [Optional].
        threshold_monitor: The threshold_monitor of this SubNetworkSingle3 [Optional].
        trace_job: The trace_job of this SubNetworkSingle3 [Optional].
        management_data_collection: The management_data_collection of this SubNetworkSingle3 [Optional].
        ntf_subscription_control: The ntf_subscription_control of this SubNetworkSingle3 [Optional].
        alarm_list: The alarm_list of this SubNetworkSingle3 [Optional].
        file_download_job: The file_download_job of this SubNetworkSingle3 [Optional].
        files: The files of this SubNetworkSingle3 [Optional].
        mns_registry: The mns_registry of this SubNetworkSingle3 [Optional].
        assurance_closed_control_loop: The assurance_closed_control_loop of this SubNetworkSingle3 [Optional].
    """
...
SubNetworkSingle3.update_forward_refs()
