...
class FileDownloadJobSingleAllOf(BaseModel):
    ...
    FileDownloadJobSingleAllOf - a model defined in OpenAPI
        ...
        attributes: The attributes of this FileDownloadJobSingleAllOf [Optional].
    """

    attributes: Optional[FileDownloadJobSingleAllOfAttributes] = Field(alias="attributes", default=None)

FileDownloadJobSingleAllOf.update_forward_refs()
