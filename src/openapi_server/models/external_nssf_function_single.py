...
class ExternalNssfFunctionSingle(BaseModel):
    ...
    ExternalNssfFunctionSingle - a model defined in OpenAPI
        ...
        id: The id of this ExternalNssfFunctionSingle.
        object_class: The object_class of this ExternalNssfFunctionSingle [Optional].
        object_instance: The object_instance of this ExternalNssfFunctionSingle [Optional].
        vs_data_container: The vs_data_container of this ExternalNssfFunctionSingle [Optional].
        attributes: The attributes of this ExternalNssfFunctionSingle [Optional].
    """
