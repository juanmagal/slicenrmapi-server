...
class NrCellDuSingle(BaseModel):
    ...
    NrCellDuSingle - a model defined in OpenAPI
        ...
        id: The id of this NrCellDuSingle.
        object_class: The object_class of this NrCellDuSingle [Optional].
        object_instance: The object_instance of this NrCellDuSingle [Optional].
        vs_data_container: The vs_data_container of this NrCellDuSingle [Optional].
        attributes: The attributes of this NrCellDuSingle [Optional].
        perf_metric_job: The perf_metric_job of this NrCellDuSingle [Optional].
        threshold_monitor: The threshold_monitor of this NrCellDuSingle [Optional].
        managed_nf_service: The managed_nf_service of this NrCellDuSingle [Optional].
        trace_job: The trace_job of this NrCellDuSingle [Optional].
        rrm_policy_ratio: The rrm_policy_ratio of this NrCellDuSingle [Optional].
        cpci_configuration_function: The cpci_configuration_function of this NrCellDuSingle [Optional].
        drach_optimization_function: The drach_optimization_function of this NrCellDuSingle [Optional].
        nr_operator_cell_du: The nr_operator_cell_du of this NrCellDuSingle [Optional].
    """
