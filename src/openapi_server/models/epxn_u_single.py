...
class EPXnUSingle(BaseModel):
    ...
    EPXnUSingle - a model defined in OpenAPI
        ...
        id: The id of this EPXnUSingle.
        object_class: The object_class of this EPXnUSingle [Optional].
        object_instance: The object_instance of this EPXnUSingle [Optional].
        vs_data_container: The vs_data_container of this EPXnUSingle [Optional].
        attributes: The attributes of this EPXnUSingle [Optional].
    """
