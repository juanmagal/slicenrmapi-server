...
class EPS1USingle(BaseModel):
    ...
    EPS1USingle - a model defined in OpenAPI
        ...
        id: The id of this EPS1USingle.
        object_class: The object_class of this EPS1USingle [Optional].
        object_instance: The object_instance of this EPS1USingle [Optional].
        vs_data_container: The vs_data_container of this EPS1USingle [Optional].
        attributes: The attributes of this EPS1USingle [Optional].
    """
