...
class TraceJobSingle(BaseModel):
    ...
    TraceJobSingle - a model defined in OpenAPI
        ...
        id: The id of this TraceJobSingle.
        object_class: The object_class of this TraceJobSingle [Optional].
        object_instance: The object_instance of this TraceJobSingle [Optional].
        vs_data_container: The vs_data_container of this TraceJobSingle [Optional].
        attributes: The attributes of this TraceJobSingle [Optional].
        files: The files of this TraceJobSingle [Optional].
    """
