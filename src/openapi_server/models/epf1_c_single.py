...
class EPF1CSingle(BaseModel):
    ...
    EPF1CSingle - a model defined in OpenAPI
        ...
        id: The id of this EPF1CSingle.
        object_class: The object_class of this EPF1CSingle [Optional].
        object_instance: The object_instance of this EPF1CSingle [Optional].
        vs_data_container: The vs_data_container of this EPF1CSingle [Optional].
        attributes: The attributes of this EPF1CSingle [Optional].
    """
