...
class NefFunctionSingle(BaseModel):
    ...
    NefFunctionSingle - a model defined in OpenAPI
        ...
        id: The id of this NefFunctionSingle.
        object_class: The object_class of this NefFunctionSingle [Optional].
        object_instance: The object_instance of this NefFunctionSingle [Optional].
        vs_data_container: The vs_data_container of this NefFunctionSingle [Optional].
        attributes: The attributes of this NefFunctionSingle [Optional].
        perf_metric_job: The perf_metric_job of this NefFunctionSingle [Optional].
        threshold_monitor: The threshold_monitor of this NefFunctionSingle [Optional].
        managed_nf_service: The managed_nf_service of this NefFunctionSingle [Optional].
        trace_job: The trace_job of this NefFunctionSingle [Optional].
        ep_n33: The ep_n33 of this NefFunctionSingle [Optional].
    """
