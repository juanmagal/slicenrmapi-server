...
class EPX2USingle(BaseModel):
    ...
    EPX2USingle - a model defined in OpenAPI
        ...
        id: The id of this EPX2USingle.
        object_class: The object_class of this EPX2USingle [Optional].
        object_instance: The object_instance of this EPX2USingle [Optional].
        vs_data_container: The vs_data_container of this EPX2USingle [Optional].
        attributes: The attributes of this EPX2USingle [Optional].
    """
