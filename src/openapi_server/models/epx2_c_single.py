...
class EPX2CSingle(BaseModel):
    ...
    EPX2CSingle - a model defined in OpenAPI
        ...
        id: The id of this EPX2CSingle.
        object_class: The object_class of this EPX2CSingle [Optional].
        object_instance: The object_instance of this EPX2CSingle [Optional].
        vs_data_container: The vs_data_container of this EPX2CSingle [Optional].
        attributes: The attributes of this EPX2CSingle [Optional].
    """
