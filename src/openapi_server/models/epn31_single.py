...
class EPN31Single(BaseModel):
    ...
    EPN31Single - a model defined in OpenAPI
        ...
        id: The id of this EPN31Single.
        object_class: The object_class of this EPN31Single [Optional].
        object_instance: The object_instance of this EPN31Single [Optional].
        vs_data_container: The vs_data_container of this EPN31Single [Optional].
        attributes: The attributes of this EPN31Single [Optional].
    """
